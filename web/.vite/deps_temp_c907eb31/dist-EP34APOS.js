import {
  ...
  k,
  y
} from "./chunk-3WMJXJPU.js";
import {
  require_sha3
} from "./chunk-YWKEZAKS.js";
import {
  import_index
} from "./chunk-I4LP7DTG.js";
import "./chunk-JEB4PRMK.js";
import {
  sha256
} from "./chunk-NVIL6IOP.js";
import {
  bytesToHex
} from "./chunk-D2AQFJ6E.js";
import {
  __commonJS,
  __toESM
...
var Snackbar = class {
  ...
  render() {
    ...
    R(k(
      "div",
      null,
      k(SnackbarContainer, { darkMode: this.darkMode }, Array.from(this.items.entries()).map(([key, itemProps]) => k(SnackbarInstance, Object.assign({}, itemProps, { key }))))
    ), this.root);
  }
};
var SnackbarContainer = (props) => k(
  "div",
  { class: clsx("-cbwsdk-snackbar-container") },
  k("style", null, Snackbar_css_default),
  k("div", { class: "-cbwsdk-snackbar" }, props.children)
);
var SnackbarInstance = ({ autoExpand, message, menuItems }) => {
  ...
  return k(
    ...
    k(
      ...
      k("img", { src: cblogo, class: "-cbwsdk-snackbar-instance-header-cblogo" }),
      " ",
      k("div", { class: "-cbwsdk-snackbar-instance-header-message" }, message),
      k(
        "div",
        ...
        !expanded && k(
          ...
          k("circle", { cx: "12", cy: "12", r: "12", fill: "#F5F7F8" })
        ),
        k("img", { src: gearIcon, class: "-gear-icon", title: "Expand" })
      )
    ),
    menuItems && menuItems.length > 0 && k("div", { class: "-cbwsdk-snackbar-instance-menu" }, menuItems.map((action, i) => k(
      "div",
      ...
      k(
        ...
        k("path", { "fill-rule": action.defaultFillRule, "clip-rule": action.defaultClipRule, d: action.path, fill: "#AAAAAA" })
      ),
      k("span", { class: clsx("-cbwsdk-snackbar-instance-menu-item-info", action.isRed && "-cbwsdk-snackbar-instance-menu-item-info-is-red") }, action.info)
    )))
  );
};
...
var RedirectDialog = class {
  ...
  render(props) {
    ...
    if (!props)
      return;
    R(k(RedirectDialogContent, Object.assign({}, props, { onDismiss: () => {
      this.clear();
...
var RedirectDialogContent = ({ title, buttonText, darkMode, onButtonClick, onDismiss }) => {
  ...
  return k(
    ...
    k(
      ...
      k("style", null, RedirectDialog_css_default),
      k("div", { class: "-cbwsdk-redirect-dialog-backdrop", onClick: onDismiss }),
      k(
        "div",
        { class: clsx("-cbwsdk-redirect-dialog-box", theme) },
        k("p", null, title),
        k("button", { onClick: onButtonClick }, buttonText)
      )
    )
  );
};
...
//# sourceMappingURL=dist-EP34APOS.js.map
